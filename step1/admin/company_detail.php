...
<tr>
					...
					<tr>
					  <th>업체명</th>
					  <td>
						<input type="text" name="company_name" id="company_name" value="<?php echo $row['company_name'] ?>" class="form-control" />
					...
					<tr>
					  <th>주소</th>
					  <td>
						<input type="text" name="addr" id="addr" value="<?php echo $row['addr'] ?>" class="form-control" />
						</td>
					</tr>
					<tr>
					  <th>전화번호</th>
					  <td>
						<input type="text" name="tel" id="tel" value="<?php echo $row['tel'] ?>" class="form-control" />
						</td>
					</tr>
					<tr>
					  <th>담당자</th>
...
<script src="https://cdn.jsdelivr.net/npm/chart.js@4.3.2/dist/chart.umd.js" integrity="sha384-eI7PSr3L1XLISH8JdDII5YN/njoSsxfbrkCTnJrzXt+ENP5MOVBxD+l6sEG4zoLp" crossorigin="anonymous"></script><script src="dashboard.js"></script></body>
	...
	<script type="text/javascript">
      ...
      button.addEventListener('click', () => {
        const form = new FormData(document.querySelector('#companyData'));
