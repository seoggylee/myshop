...
<div class="container-fluid">
  <div class="row">
	...
	<?php 
		...
		$company_list = get_company_list($connect, 0, 1000);
		
	?>
	  <h2>상품정보</h2>
	  <form method="POST" action="goods_save.php" id="profileData" enctype="multipart/form-data">
...
<tr>
					  ...
					  <td>
						...
						<img id="thumbname_img" src='../../img/<?php echo $row['thumbnail'] ?>' style='width:300px;height:300px;'></td>
					</tr>
					<tr>
					  <th>상품번호</th>
					  <td>
					...
					<tr>
					  <th>재고수량</th>
					  <td>
						<input type="text" name="quantity" id="quantity" value="<?php echo $row['quantity'] ?>" class="form-control" />
						</td>
					</tr>
					<tr>
					  <th>상품가격</th>
					...
					<tr>
					  ...
					  <select class="form-select" name="company_idx" id="company_idx">
						<option value="">공급업체선택</option>
						<?php foreach( $company_list as $company ) { ?>
						<option value="<?php echo $company['idx'] ?>" <?php if($row['company_idx'] == $company['idx']) { echo 'selected'; } ?> ><?php echo $company['company_name'] ?></option>
						<?php } ?>
					  </select>
					</td>
					</tr>
...
<?php
			...
			<button type="button" id="submit" class="btn btn-outline-primary">저장</button>
		  </div>
		</form>
