...
?>
  <div class="container marketing">
    ...
    <form action="./cart.php" id="frmCart" method="post">
    ...
    <div class="row">
      ...
      <div class="col-lg-4">
        <img src='../img/<?php echo $row['THUMBNAIL'] ?>' style='width:300px;height:300px;'>
  ...
  <input type="text" class="form-control" aria-label="Recipient's username with two button addons" value="1" id='amount' name="amount">
...
<h3>
총 합계 금액 (수량)
  <span class="text-body-secondary" id='total'><?php echo number_format($row['price']) ?>원 (1개)</span>
</h3>
      ...
      <div class="col-lg-12">공급업체 : <?php echo $row['company_name'] ?></div>
      <div class="col-lg-12"><span>재고량 : <?php echo $row['quantity'] ?></span></div>
